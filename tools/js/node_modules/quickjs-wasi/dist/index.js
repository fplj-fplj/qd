...
export class QuickJS {
        ...
        return {
            ...
            get settled() {
                if (!_settled) {
                    ...
                    vm.callFunctionRaw(vm.getPromiseThen(), promiseHandle, onSettleFn, onSettleDup).dispose();
                    onSettleFn.dispose();
                    onSettleDup.dispose();
                }
                return _settled;
    ...
    resolvePromise(promiseHandle) {
        ...
        return new Promise((hostResolve) => {
            ...
            this.callFunctionRaw(this.getPromiseThen(), promiseHandle, onFulfilled, onRejected).dispose();
            onFulfilled.dispose();
            onRejected.dispose();
        });
    }
